...
<head>
    ...
    <title>Franklin's Key — Unlock Electricity</title>
...
<body>
    ...
    <div class="container">
        ...
        <a href="/auth/google" style="display:inline-flex;align-items:center;gap:0.5rem;padding:0.7rem 1.5rem;font-size:0.9rem;font-weight:700;color:#0a0a0f;background:white;border-radius:8px;text-decoration:none;margin-bottom:1rem;transition:all 0.3s;" onmouseover="this.style.background='#e5e7eb'" onmouseout="this.style.background='white'">
